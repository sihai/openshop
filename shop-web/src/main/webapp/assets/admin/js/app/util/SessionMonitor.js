 ...
 * logged out.
 */
Ext.define('meetup.util.SessionMonitor', {
  singleton: true,
  ...
  window: Ext.create('Ext.window.Window', {
    ...
    buttons: [{
      ...
      handler: function() {
        Ext.TaskManager.stop(meetup.util.SessionMonitor.countDownTask);
        meetup.util.SessionMonitor.window.hide();
        meetup.util.SessionMonitor.start();
