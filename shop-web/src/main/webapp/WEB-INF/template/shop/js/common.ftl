...
var setting = {
	...
	usernameMinLength: ${setting.usernameMinLength},
	usernameMaxLength: ${setting.usernameMaxLength},
	msgMinLength: ${setting.msgMinLength},
	msgMaxLength: ${setting.msgMaxLength}
};
