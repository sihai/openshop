...
<title>${message("admin.plugin.alipayDirect.setting")} - Powered By openteach inc.</title>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="key" class="text" value="${pluginConfig.attributes["key"]}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
