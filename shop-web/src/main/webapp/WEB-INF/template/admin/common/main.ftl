...
<title>${message("admin.main.title")} - Powered By openteach inc.</title>
			...
			<th>
				<div id="nav" class="nav">
					<ul>
						...
						[#list ["admin:supplier"] as permission]
							[@shiro.hasPermission name = permission]
								<li>
									<a href="#supplier">${message("admin.main.supplierNav")}</a>
								</li>
								[#break /]
							[/@shiro.hasPermission]
						[/#list]
				...
				<div class="link">
					<a href="http://www.aigechibaole.com" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.AIGECHIBAOLE" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.aigechibaole.com/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
		...
		<tr>
			<td id="menu" class="menu">
				...
				<dl id="supplier" class="default">
					<dt>${message("admin.main.supplierGroup")}</dt>
						<dd>
							<a href="../supplier/list.jhtml" target="iframe">${message("admin.main.supplier")}</a>
						</dd>
						<dd>
							<a href="../cooperation/list.jhtml" target="iframe">${message("admin.main.cooperation")}</a>
						</dd>
				</dl>
				[/@shiro.hasPermission]
			...
			<td>
				<iframe id="iframe" name="iframe" src="index.jhtml" frameborder="0" height="100%" width="100%" marginwidth="0" marginheight="0" hspace="0" vspace="0" scrolling="auto"></iframe>
			</td>
		</tr>
	</table>
</body>
