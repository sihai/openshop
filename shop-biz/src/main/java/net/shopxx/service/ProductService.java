...
public interface ProductService extends BaseService<Product, Long> {
	 ...
	 * @return 商品数量
	 */
	Long count(Supplier supplier, Member favoriteMember, Boolean isMarketable, Boolean isList, Boolean isTop, Boolean isGift, Boolean isOutOfStock, Boolean isStockAlert);
	...
	long viewFavours(Long id);

	void updateProductFavorCache(Long id);
