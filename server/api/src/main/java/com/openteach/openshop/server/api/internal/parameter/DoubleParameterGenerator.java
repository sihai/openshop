 ...
 *
 */
public class DoubleParameterGenerator extends AbstractSimpleParameterGenerator {
	 ...
	 * @param required
	 */
	public DoubleParameterGenerator(ParameterType type, String name, boolean required) {
		super(type, name, required);
	}
	
	@Override
	public Object generateValue(Object v) throws ParameterGeneratedException {
		return ConvertUtils.asDouble(v);
	}
}
