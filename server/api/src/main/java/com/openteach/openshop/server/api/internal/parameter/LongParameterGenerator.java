 ...
 *
 */
public class LongParameterGenerator extends AbstractSimpleParameterGenerator {
	 ...
	 * @param required
	 */
	public LongParameterGenerator(ParameterType type, String name, boolean required) {
		super(type, name, required);
	}
	
	@Override
	public Object generateValue(Object v) throws ParameterGeneratedException {
		return ConvertUtils.asLong(v);
	}
}
