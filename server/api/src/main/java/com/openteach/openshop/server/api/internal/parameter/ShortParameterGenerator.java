 ...
 *
 */
public class ShortParameterGenerator extends AbstractSimpleParameterGenerator {
	 ...
	 * @param required
	 */
	public ShortParameterGenerator(ParameterType type, String name, boolean required) {
		super(type, name, required);
	}
	
	@Override
	public Object generateValue(Object v) throws ParameterGeneratedException {
		return ConvertUtils.asShort(v);
	}
}
