 ...
 *
 */
public class BooleanParameterGenerator extends AbstractSimpleParameterGenerator {
	 ...
	 * @param required
	 */
	public BooleanParameterGenerator(ParameterType type, String name, boolean required) {
		super(type, name, required);
	}
	
	@Override
	public Object generateValue(Object v) throws ParameterGeneratedException {
		return ConvertUtils.asBoolean(v);
	}
}
