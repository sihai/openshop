...
import com.openteach.openshop.server.biz.BigDecimalNumericFieldBridge;
...
public class Product extends BaseEntity {
	...
	public static final String FAVORS_CACHE_NAME = "productFavours";
	

	/** 点击数缓存更新间隔时间 */
	public static final int HITS_CACHE_INTERVAL = 600000;
	
	public static final int FAVORS_CACHE_INTERVAL = 600000;
	...
	public String getParameterValue(Parameter parameter) {
		Map<Parameter, String> map = this.getParameterValue();
		if(null == map) {
			return "";
		}
