 ...
 */
package com.openteach.openshop.server.biz.captcha;
...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		...
		BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, this.getClass().getResource(BACKGROUND_IMAGE_PATH).getFile());
