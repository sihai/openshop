...
public class ExcelView extends AbstractExcelView {
	 ...
	 *            附加内容
	 */
	public ExcelView(String filename, String sheetName, String[] properties, String[] titles, Short[] widths, Converter[] converters, Collection<?> data, String[] contents) {
	 ...
	 *            列宽
	 */
	public void setWidths(Short[] widths) {
		this.widths = widths;
	}
