...
public class BaseController {
	...
	/** 错误视图 */
	protected static final String ERROR_VIEW = "/supplier/common/error";
	
	protected static final String SUPPLIER_ERROR_VIEW = "/supplier/common/error";

	/** 错误消息 */
	protected static final Message ERROR_MESSAGE = Message.error("supplier.message.error");

	/** 成功消息 */
	protected static final Message SUCCESS_MESSAGE = Message.success("supplier.message.success");
