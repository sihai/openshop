...
<title>${message("supplier.error.title")} - Powered By openteach inc.</title>
...
<body>
	<div class="wrap">
		<div class="error">
			<dl>
				<dt>${message("supplier.error.message")}</dt>
				[#if content??]
					<dd>${content}</dd>
				[/#if]
				...
				[/#if]
				<dd>
					<a href="javascript:;" onclick="window.history.back(); return false;">${message("supplier.error.back")}</a>
				</dd>
			</dl>
		</div>
	</div>
