...
<title>${message("supplier.print.delivery")} - Powered By openteach inc.</title>
...
$().ready(function() {
	...
	$print.click(function() {
		if ($deliveryTemplate.val() == "") {
			$.message("warn", "${message("supplier.print.deliveryTemplateRequired")}");
			return false;
		}
		if ($deliveryCenter.val() == "") {
			$.message("warn", "${message("supplier.print.deliveryCenterRequired")}");
			return false;
		}
		window.print();
		return false;
...
<body>
	<div class="bar">
		<form id="deliveryForm" action="delivery.jhtml" method="get">
			...
			${message("supplier.print.deliveryTemplate")}:
			...
			${message("supplier.print.deliveryCenter")}:
