...
<title>${message("supplier.print.order")} - Powered By openteach inc.</title>
	...
	<div class="content">
		<table>
			<tr>
				...
				<td colspan="2">
					${message("Order.consignee")}: ${orderItem.order.consignee}
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr class="separated">
				...
				<td colspan="3">
					${message("Order.consignee")}: ${orderItem.order.consignee}<br />
					${message("Order.address")}: ${orderItem.order.areaName}${order.address}<br />
					${message("Order.zipCode")}: ${orderItem.order.zipCode}<br />
					${message("Order.phone")}: ${orderItem.order.phone}<br />
					${message("Order.shippingMethod")}: ${orderItem.order.shippingMethodName}
				</td>
			</tr>
			<tr>
				<td>
