...
<title>${message("admin.product.add")} - Powered By openteach inc.</title>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			...
			<tr>
				...
				<td>
					<input type="text" name="rebatePoint" class="text" maxlength="3" title="${message("admin.product.rebatePointTitle")}" /> %
				</td>
			</tr>
		</table>
