...
<title>${message("admin.product.list")} - Powered By openteach inc.</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="isMarketable">${message("Product.supplier")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="isMarketable">${message("Product.rebatePoint")}</a>
				</th>
				<th>
			...
			[#list page.content as product]
				<tr>
					...
					<td>
						[#if product.rebatePoint??]
							${currency(product.rebatePoint)}
						[/#if]
					</td>
					<td>
