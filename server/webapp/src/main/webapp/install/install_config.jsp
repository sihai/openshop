...
<%
	...
	if (databaseMajorVersion == 8) {
		...
		try {
	Resource resource = new ClassPathResource(CommonAttributes.OPENSHOP_PROPERTIES_PATH);
	...
	if (status.equals("success")) {
		try {
	File shopxxXmlFile = new ClassPathResource(CommonAttributes.OPENSHOP_XML_PATH).getFile();
