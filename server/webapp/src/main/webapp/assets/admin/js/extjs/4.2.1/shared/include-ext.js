...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="' /*+ path*/ + '/assets/js/extjs/4.2.1/resources/css/ext-all' + suffix + '-debug.css"/>');
    }
    ...
    if (neptune) {
        ...
        neptunePath = /*(repoDevMode ? path + '/..' : path) + */
            '/assets/js/extjs/4.2.1/packages/ext-theme-neptune/build/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
