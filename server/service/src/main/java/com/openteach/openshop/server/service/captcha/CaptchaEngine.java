 ...
 */
package com.openteach.openshop.server.service.captcha;
...
public class CaptchaEngine extends ListImageCaptchaEngine {
	...
	protected void buildInitialFactories() {
		...
		//System.out.println(this.getClass().getResource(BACKGROUND_IMAGE_PATH).toExternalForm());
		BackgroundGenerator backgroundGenerator = new FileReaderRandomBackgroundGenerator(IMAGE_WIDTH, IMAGE_HEIGHT, /*this.getClass().getResource(BACKGROUND_IMAGE_PATH).getFile()*/ Thread.currentThread().getContextClassLoader().getResource(BACKGROUND_IMAGE_PATH).getFile());
